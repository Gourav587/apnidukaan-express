...
Deno.serve(async (req) => {
  ...
  try {
    const { email, password, setup_token } = await req.json();
    ...
    return new Response(
      JSON.stringify({ success: true, message: "Admin account created successfully. You can now log in at /admin-login." }),
